...
public class DetailKategorialActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String url_detail = ServerApi.URL_VIEW_DETAIL_KATEGORIAL;
    String tag_json_obj = "json_obj_req";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detail_katagorial);
        ...
        Back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DetailKategorialActivity.super.onBackPressed();
                finish();
            }
        });
    ...
    private void callDetailNews(final String id) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST, url_detail, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(DetailKategorialActivity.this,

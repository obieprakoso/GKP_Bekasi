...
public class NonKategorialAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<NonKategorialModel> newsItems;
    ImageLoader imageLoader;

    public NonKategorialAdapter(Activity activity, List<NonKategorialModel> newsItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        NonKategorialModel news = newsItems.get(position);
